      ...
      <div class="lg:w-6/12 lg:mr-10">
        <div class="lg:flex mb-10">
          <div class="lg:w-1/2 mb-10 lg:mr-5 lg:mb-0">
            ...
            <p class="text-md p-1.5 border-2 border-gray-200 focus:border-green-200 rounded-md"></p>
          </div>
        ...
        <div class="mb-10">
          ...
          <p class="w-full text-md p-2 border-2 border-gray-200 focus:border-green-200 rounded-md"></p>
        </div>
